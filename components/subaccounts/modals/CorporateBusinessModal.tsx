        ...
        <div className="w-[33rem] h-[40rem] rounded-[0.63rem] bg-white">
          <div className="flex flex-col mx-6 mt-6">
            <div className="flex items-center justify-between">
              <div
                onClick={() => handlerFunc("business-type")}
            ...
            <div
              onClick={() => handlerFunc("verify")}
              className="flex justify-center mt-6"
            >
              <button className="w-[12.5rem] h-11 bg-primary rounded-[0.313rem] text-white text-base font-WorkSans leading-5">
                Start verification
              </button>
            </div>
          </div>
