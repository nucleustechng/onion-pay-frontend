                ...
                >
                  <div className="flex flex-col">
                    <div className="flex justify-center">
                      <Image
                        src={IndividualBusiness}
                        alt="Individual Business Illustration"
                      />
                    </div>
                    <div className="px-6 mt-6">
                      <h1 className="text-center text-xl text-[#1B1A1A] font-WorkSans font-medium leading-5 mb-4">
                        Individual Business
                      </h1>
