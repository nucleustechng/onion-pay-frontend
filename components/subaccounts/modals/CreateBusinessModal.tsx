          ...
          <div className="flex flex-col mx-6 mt-6 ">
            ...
            <div className="flex flex-col gap-4 mt-6">
              <Input
                ...
                onChange={(e) =>
                  setBusinessInfo({ ...businessInfo, b_name: e.target.value })
                }
              ...
              <Input
                ...
                onChange={(e) =>
                  setBusinessInfo({ ...businessInfo, b_email: e.target.value })
                }
              ...
              <Input
                ...
                onChange={(e) =>
                  setBusinessInfo({ ...businessInfo, b_phone: e.target.value })
                }
                placeholder="+234"
            ...
            <div className="flex items-center justify-end gap-4 mt-6">
              ...
              >
                <div className="flex justify-center items-center">
                  {isLoading ? <Loader isWhite={true} /> : "Create business"}
                </div>
              </button>
            </div>
          </div>
