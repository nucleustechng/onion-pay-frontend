            ...
            <div className='flex justify-between items-center mr-9 mb-12'>
                ...
                <div className='w-auto flex justify-between items-center pt-12'>
                    ...
                    <div className='flex justify-end'>
                        <div onClick={() => {setShowModal(true)}} className='flex justify-center items-center cursor-pointer w-[10rem] md:w-[12.5625rem] h-11 gap-[0.625rem] rounded-[0.3125rem] bg-primary'>
