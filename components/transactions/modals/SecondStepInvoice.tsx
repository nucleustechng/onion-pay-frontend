...
const SecondStepInvoice = ({ isVisible, onClose }: Props) => {
  ...
  return (
    <div>
      <div
        className="fixed inset-0 bg-[#262626] bg-opacity-50 backdrop-blur-[0.05rem] z-40 flex justify-center items-center overflow-x-scroll"
        id="wrapper"
        onClick={handleClose}
      >
          ...
          <div className="mx-4 lg:mx-6 mt-7">
            ...
            <div className="flex flex-col gap-6 mt-6 ">
              <Input
                ...
                type="text"
                label="Customer name"
                placeholder="Enter an existing customer name"
              />
              <Input
                width="w-[20.5rem] md:w-[25rem] lg:w-[30rem]"
                type="email"
              ...
              <div className="flex gap-[0.38rem] items-center">
                <Input
                  width="w-[10.1rem] md:w-[12.25rem] lg:w-[14.82rem]"
                  type="text"
                  label="City"
                  placeholder="Wuse 2"
                />
