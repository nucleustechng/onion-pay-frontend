          ...
          <div className="mx-4 lg:mx-6 mt-7">
            ...
            <div className="flex flex-col gap-6 mt-6 ">
              <Input
                ...
                onChange={(e) =>
                  setInvoiceInfo({ ...invoiceInfo, full_name: e.target.value })
                }
                type="text"
                label="Client Name"
              ...
              <Input
                ...
                onChange={(e) =>
                  setInvoiceInfo({ ...invoiceInfo, phone: e.target.value })
                }
                type="text"
                label="Client Phone"
                placeholder="+234"
              ...
              <div className="flex items-center justify-end gap-4 mt-2">
                ...
                <div
                  ...
                  className="w-[6.5rem] h-11 cursor-pointer flex items-center justify-center bg-[#3063E9] rounded-[0.313rem] text-base text-white font-WorkSans font-normal leading-5"
                >
