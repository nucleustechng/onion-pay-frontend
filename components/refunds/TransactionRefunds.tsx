...
const TransactionRefunds = () => {
  ...
  return (
    <div>
      {showEmpty ? (
        <div className="w-[23rem] sm:w-[45rem] md:w-[50rem] lg:w-[60rem] xl:w-[70rem] mt-6 lg:mx-6">
    ...
    <div className='flex items-center justify-center gap-3 w-[9rem] lg:w-[12.75rem] h-11 bg-primary rounded-[0.33rem] mt-10 cursor-pointer'  onClick={()=>{
      setShowModal(true)
      }}>
      <h1 className='text-sm md:text-base text-[#FFFFFF] font-normal font-WorkSans leading-5'>Log a refund</h1>
      <FontAwesomeIcon icon={faPlus} className='text-[#FFFFFF]  w-5 h-5'/>
    </div>
  </div> */}
          <div className="flex flex-col gap-5 mt-6 w-auto mx-4">
            ...
            <div className="w-[21rem]">
              <p className="text-base text-[#262626] font-WorkSans font-normal leading-5">
                You will see the record of all your refunds to your customers
                here when you log a refund.
              </p>
            </div>
            <div>
              <div
            ...
            <div className="flex flex-col lg:flex xl:flex xl:flex-row  mx-1 md:mx-3 lg:mx-5 lg:flex-col lg:justify-between">
              ...
              <div className="flex md:items-center md:justify-start mt-5  md:mr-5  xl:hidden ">
                <div className="flex gap-4">
                  ...
                  <div className="flex justify-between items-center ">
                    <div
                      className="flex justify-center items-center gap-4 rounded-[0.32rem] text-white bg-[#3063E9] w-[9.15rem] h-11 text-base font-WorkSans font-normal leading-4 cursor-pointer"
                      onClick={() => {
                        setShowModal(true);
                      }}
                    >
