    ...
    <div>
        <div className='flex flex-col bg-white '>
            <div className='flex flex-col gap-[0.375rem] mt-[1.875rem] md:gap-6'>
                <h2 className='w-[10.94rem] text-xl text-primaryText font-WorkSans font-normal leading-6
                sm:w-[20rem] sm:text-4xl
                '>Run a progressive business with our</h2>
                <h1 className='w-[11.19rem] text-5xl md:text-[5rem] text-primary font-SpaceGrotesk font-bold leading-[2.75rem]
            ...
            <div className='flex flex-col gap-[0.375rem] mt-[2.7rem] md:hidden'>
              <h2 className='w-[9.945rem] text-xl text-primaryText font-WorkSans font-normal leading-[1.625rem]
              sm:W-[20rem] sm:text-2xl
              '>A fully unified set of payments</h2>
            ...
            <div className='flex flex-col gap-5 mt-5'>
                ...
                <div className='hidden  md:flex md:relative md:bottom-20 lg:flex lg:relative lg:bottom-20'>
                    <div>
                      <p className='text-[3.38rem] text-primaryText font-WorkSans font-normal leading-[3.94rem]'>Quick and easy-to-use</p>
                      <h1 className='text-[5rem] text-[#FF9635] font-SpaceGrotesk font-bold leading-[6.4rem]'>Payments tools.</h1>
                    </div>
                    <div className='hidden xl:flex xl:absolute xl:left-[35rem] xl:top-[12rem]
                ...
                <div className='w-[21.875rem] mb-[3.75rem]
                sm:w-[37rem] lg:mt-[47rem] lg:w-[60rem]
                '>
                  <p className='mb-[1.875rem] text-[2.5rem] text-primaryText font-WorkSans font-normal  leading-[2.94rem]
