...
const LargeToolSectCard = ({backgroundColor,header,img,mainText,height,top,left,route,routeText}: Props) => {
  return (
    <div>
            ...
            <div className='flex justify-center pt-6'>
                <div className='flex flex-col gap-6  xl:w-[18.515rem] md:w-[15rem] px-6'>
                    ...
                    <Link href={route} className='flex items-center gap-[0.375rem]'>
                        <h1 className='text-white xl:text-base md:text-sm  font-WorkSans font-normal leading-5'>{routeText ? routeText : 'Learn more'}</h1>
