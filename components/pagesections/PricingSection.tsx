...
const PricingSection = () => {
  const headingStyle =
    "text-primary text-4xl font-WorkSans font-normal leading-10";
  ...
  const ListComponent = ({ text }: Props) => (
    <div className="flex items-center gap-3">
      <div>
        <Image src={Ellipse} width={10} height={10} alt="Ellipse" />
      </div>
      <h1 className="text-sm text-[#1B1A1A] font-WorkSans font-normal uppercase leading-4">
        {text}
      </h1>
    </div>
  );
