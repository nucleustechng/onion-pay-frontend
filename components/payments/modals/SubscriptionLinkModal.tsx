          ...
          <div className="flex flex-col mx-6 mt-6">
            <div className="flex justify-between items-center">
              <div
                ...
                onClick={() => dispatch(setSecondStep(false))}
              >
            ...
            <div className="flex flex-col gap-5 mt-6 ">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div>
                    <input
                      ...
                      inputMode="numeric"
                      placeholder="0.00"
                      className="flex px-5 items-center border-[0.07rem] outline-none  border-solid border-[#CACACA] rounded-[0.315rem] w-[20rem] md:w-[22.5rem] h-[3.15rem]"
                    />
                  </div>
                </div>
              ...
              <div>
                <div className="flex flex-col gap-2">
                  ...
                  >
                    Redirect after payment <span>(Optional)</span>
                  </label>
                  <input
                    name="redirect_url"
