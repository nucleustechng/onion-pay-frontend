        ...
        <div className="w-[25rem] h-[23.2rem] rounded-[0.63rem] bg-white">
          <div className="mx-6 mt-6">
            <div className="relative flex justify-center items-center">
              <h1 className="text-xl text-[#1B1A1A] font-WorkSans font-semibold leading-5">
                Verify your account
              </h1>
              <div
            ...
            <div className="flex flex-col gap-3 mt-6">
              <p className="text-base text-[#1B1A1A] text-center font-WorkSans font-normal leading-5">
                Hello, In order to successfully withdraw payments from your
                transactions, you will need to verify your account.
              </p>
              <p className="text-base text-[#1B1A1A] text-center font-WorkSans font-normal leading-5">
                Verifying your account helps us ensure that your identity and
                money are kept safe and secure.
              </p>
            </div>
