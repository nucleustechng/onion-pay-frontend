            ...
            <div className={`w-[22rem] md:w-[33.01rem] md:mb-80 lg:mb-0 ${!isFixed ? 'h-[31rem]' : 'h-[38.5rem]'} ${!isFixed ? "md:h-[31rem]" : "md:h-[38rem]"} rounded-[0.63rem] bg-white`}>
                <div className='flex flex-col mx-6 mt-6'>
                    ...
                    <div className='flex flex-col gap-5 mt-6 '>
                        ...
                        <div className='flex justify-between items-center'>
                            <h1 className='text-[#262626] text-sm font-WorkSans font-normal leading-4 mb-2'>Fixed amount</h1>
                            <CustomToggle
                            onChange={() => {
                              setFixed(!isFixed)
                              setPaymentLinkInfo({...paymentLinkInfo, fixed: isFixed})
                        ...
                        {isFixed && <div className='flex flex-col '>
                            ...
                            <div className=''>
                                ...
                                type='number'
                                inputMode='numeric' 
                                placeholder='0.00' className='flex px-5 items-center border-[0.07rem] outline-none  border-solid border-[#CACACA] rounded-[0.315rem] w-[19rem] md:w-[29.9rem] h-[3.15rem]'/>
                                </div>
                            </div>
