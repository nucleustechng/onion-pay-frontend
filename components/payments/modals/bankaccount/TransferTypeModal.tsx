                ...
                <div className='mx-5 my-6'>
                    <div className='flex items-center justify-between'>
                        <div className='flex items-center gap-3'>
                            ...
                            <h1 className='text-lg text-[#262626] font-WorkSans font-semibold leading-5'>Transfer to Bank account</h1>
                        </div>
                        <div>
                    ...
                    {/* First payment link select */}
                        ...
                        >
                            ...
                            <div className='flex flex-col gap-4 items-center '>
                                ...
                                <p className=' text-base text-center text-[#262626] font-WorkSans font-normal leading-5'>This type of transfer allows you to send money to one bank account at a time.</p>
                            </div>
                        </div>
                         ...
                         >
                            ...
                            <div className='flex flex-col gap-4 items-center'>
                                ...
                                <p className=' text-base text-center text-[#262626] font-WorkSans font-normal leading-5'>This type of transfer allows you to send money to multiple bank accounts at the same time.</p>
                            </div>
                        </div>
                    </div>
