  ...
  return (
    <div>
          <div className='fixed inset-0 bg-[#262626] bg-opacity-50 backdrop-blur-[0.05rem] flex justify-center items-center' id='wrapper' onClick={handleClose}>
            <div className='w-[33.26rem] h-[40.51rem] rounded-[0.63rem] bg-white'>
              <div className='mx-6 mt-6'>
                  ...
                  <div>
                    <h1 className='text-sm text-[#C70039] font-WorkSans font-medium leading-4'>Please enter the amount you want to send</h1>
                  </div>
                  {/* Input three */}
                  ...
                  {/* Input four */}
                  <div className='flex flex-col gap-2 mt-4'>
                  <label className='text-[#262626] text-sm font-WorkSans font-normal leading-4'>Account number</label>
                     <input type='number' className='flex px-5 items-center border-[0.07rem]  border-solid border-[#CACACA] rounded-[0.315rem] w-[30rem] h-[3.15rem] outline-none'/>
                  </div>
                  {/* Input five */}
                  <div>
