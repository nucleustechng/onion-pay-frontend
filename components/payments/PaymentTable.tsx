    ...
    <div>
      ...
      <div className="flex items-center  rounded-[0.32rem] w-[71.5rem] h-[3.75rem] ">
        <div className="w-[10.25rem]">
          <h1 className="text-base text-[#262626] font-WorkSans font-normal leading-[1.2rem]">
            {pageName}
          </h1>
        </div>
        ...
        <div className="w-[14.3rem]">
          <h1 className="text-base text-[#262626] font-WorkSans font-normal leading-[1.2rem] truncate">
            {description}
          </h1>
        </div>
        ...
        {showPopover && selectedLinkId && (
          <div
            ...
            style={{
              top: `calc(${
                popoverRef.current?.parentElement?.getBoundingClientRect().top
              }px + 2rem)`,
              left: `calc(${
                popoverRef.current?.parentElement?.getBoundingClientRect().left
              }px + 2rem)`,
            }}
          >
