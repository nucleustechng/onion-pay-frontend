  ...
  return (
    <div>
          <div className='lg:mx-6 lg:mt-6'>
            <div>
                <h1 className='text-[#262626] lg:text-[2rem] font-WorkSans font-medium leading-9'>Payment Plans</h1>
            </div>
            <div className='flex lg:gap-[32rem] items-center mt-[3.2rem]'>
                <h1 className='text-base text-[#262626] font-WorkSans font-normal leading-5'>3 payment plans</h1>
            <div className='flex gap-4   items-center '>
                ...
                <div>
                  <div className='flex  items-center lg:w-[12.5rem] lg:h-11 rounded-[0.32rem] bg-[#F5F5F5] '>
                    <div className='flex  items-center mx-4 gap-4'>
                      <h1 className='text-base font-WorkSans font-normal text-[#262626]'>All payment links</h1>
                ...
                <div>
                  <div className='flex  items-center lg:w-[13.2rem] lg:h-11 rounded-[0.32rem] bg-[#3063E9] '>
                    <div className='flex  items-center mx-4 gap-4'>
                      <h1 className='text-base font-WorkSans font-normal text-white'>New payment plan</h1>
