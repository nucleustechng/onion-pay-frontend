    ...
    <div>
        ...
        <Link href={isAccountRoute ? router.pathname : '/settings/merchant'}>
                        ...
                        <ul className={`${account ? 'flex flex-col h-16 translate-x-0 ease-in-out duration-500' : 'overflow-hidden p-0 h-0 ease-in-out -translate-x-28 duration-500'}   gap-[0.63rem]  mb-0 mt-[0.5rem] mx-6`}>
                                    <Link href='/settings/merchant'><li className={`text-sm 
                                   ${merchantRoute ? 'text-primary' : 'text-[#262626]'} font-WorkSans font-normal leading-4`}>Merchant</li></Link>
                                   <Link href='/settings'><li className={`text-sm 
                                   ${businessSettingRoute ? 'text-primary' : 'text-[#262626]'} font-WorkSans font-normal leading-4`}>Business</li></Link> 
                            </ul>
                    </Link>
        </div>
    </div>
