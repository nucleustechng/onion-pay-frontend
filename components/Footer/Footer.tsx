	...
	return (
		<div>
			<div className="w-full h-auto bg-[#303778]">
				<div
					className="flex flex-col gap-11 ml-5 pt-[3.125rem] 
            md:flex md:flex-row md:flex-wrap md:px-[2rem] md:gap-[4.675rem]
            lg:flex lg:flex-row lg:flex-wrap lg:ml-[5.375rem] "
				>
					<FooterItem
						header="Products"
						linkArray={productsArray}
					/>
					<FooterItem
						header="Resources"
						linkArray={resourcesArray}
					/>
					<FooterItem
						header="Developers"
						linkArray={developersArray}
					/>
					<FooterItem
						header="Onion Pay"
						linkArray={onionPayArray}
					/>
					<FooterItem
						header="Contact"
						linkArray={contactArray}
					/>
				</div>
