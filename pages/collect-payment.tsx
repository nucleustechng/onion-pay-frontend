        ...
        <div className='h-[30rem] md:h-[50rem] mt-32'>
            <div  className='lg:flex lg:justify-between '>
                <div className='flex flex-col gap-6  w-[10rem] mx-4 md:pt-32 md:ml-[5rem] lg:ml-[4rem] xl:ml-[9.375rem]'>
                    ...
                    font-bold leading-[4.5rem] md:leading-[5rem]'>Collect payments <span className='text-[#FF9635]'>anywhere<span className='italic'>!</span></span></h1>
                    <p className='w-[22rem] md:w-[26.125rem] h-[1.875rem] text-xl  md:text-2xl text-[#1B1A1A] font-WorkSans font-normal  leading-[1.875rem]'>Receive money from anyone, at any time, anywhere in the world.</p>
