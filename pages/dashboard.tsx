        ...
        <div className="w-[71.5rem] mx-6 lg:mt-7">
          ...
          <div className="flex justify-between mt-[3.4rem]">
            ...
            <div className="w-[18.8rem] h-[28.5rem]  rounded-[0.65rem] bg-[#303778]">
              <div className="divide-y-2 divide-solid mx-5 mt-20  divide-white">
                <div>
                  <div className="flex flex-col mb-10">
                    <h2 className="font-WorkSans font-normal text-xs mb-4 text-white leading-3">
                      Total Value
                    </h2>
                    <h1 className="font-WorkSans font-medium text-lg text-white leading-[1.35rem]">
                      NGN 304.20
                    </h1>
                  </div>
                  <div className="flex flex-col mb-10">
              ...
              <h1 className="text-white mt-6 text-base font-WorkSans font-normal  leading-[1.2rem] mx-5">
                See all settlements
              </h1>
            </div>
          </div>
