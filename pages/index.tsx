	...
	return (
        ...
        "
            ...
            "
					>
						<div
							className="relative w-[15rem] min-[492px]:w-[30rem] sm:w-[35rem] lg:w-[40rem] xl:w-[46.875rem] 
                  min-[375px]:w-[19.5rem] 
                  min-[412px]:w-[19rem] min-[390px]:w-[19.5rem] min-[360px]:w-[14rem] min-[540px]:w-[20rem]"
						>
							<h1
								className="text-[#303778] text-[4rem] font-extrabold font-SpaceGrotesk leading-[4.375rem]
                  ...
                  "
						...
						<div
							className="absolute bottom-52 left-72
            ...
            "
					>
						<p
							className="text-primaryText text-xl font-WorkSans font-light leading-6
             ...
             sm:w-[30rem] sm:text-3xl
              "
						>
							Process payments, manage revenue, and use tools designed to grow
							your business.
						</p>
						<Link
							href="/auth/signup"
                ...
                sm:w-[20rem]"
					...
					<div className="inline-flex lg:hidden">
						<Image
							...
							loading="lazy"
							alt="Hero sect"
							className="w-screen md:w-[72rem] "
						/>
					</div>
					<div
						className="hidden  lg:inline-flex lg:absolute lg:bottom-0 lg:right-20 lg:z-20
              "
					>
						<Image
							src={LargeHeroSect}
					...
					<div
						className="lg:absolute lg:inline-flex hidden
			...
			<div className="mt-24">
				<h1 className="text-center text-[5.625rem] text-[#FF9635] font-SpaceGrotesk font-bold">
					Pricing
				</h1>
				<PricingSection />
			</div>
