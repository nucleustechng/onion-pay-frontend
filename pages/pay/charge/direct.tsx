...
//   }
  ...
  const [retrieveLink,{isLoading,isSuccess,data:retrievedData}] = useRetrieveLinkMutation()

  const handleRetrieve = async () => {
    if (data.reference && data.redirect_url && data.amount && data.customer.email && data.customer.name){
...
<Input
  ...
  />
        ...
        <div  onClick={handleRetrieve} className='flex justify-center items-center w-44 h-11 bg-primary cursor-pointer text-white rounded-md mt-8 mb-48'>
