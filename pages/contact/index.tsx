    ...
    <div>
      <div className="flex justify-center lg:flex lg:flex-row lg:justify-center  ">
        <div className="flex flex-col pt-32 pb-10 ">
          <div
            className="w-[21.875rem] flex justify-center 
                    sm:w-[29rem] lg:w-[61.5rem] lg:flex lg:justify-center xl:w-[71.25rem]
                    "
          >
            <h1 className="text-5xl text-center text-[#303778] font-SpaceGrotesk font-bold">
              How may
              <span className="text-[#FF9635]"> we</span> be of
              <span className="text-[#FF9635]"> help?</span>
            </h1>
          </div>
          <div
            className="flex flex-col gap-3 w-[21.875rem] mt-11 lg:mb-[32rem] relative  
              ...
              <div onClick={() => setTab(3)}>
                <ContactCard
                  ...
                  borderRadius={`rounded-[0.625rem] ${
                    tab === 3
                      ? "lg:rounded-tl-[0.625rem] lg:rounded-tr-[0.625rem] lg:rounded-b-[0px]"
                      : ""
                  }`}
                  img={Transactions}
                />
