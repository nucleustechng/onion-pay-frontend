...
const Verifyemail = () => {
  ...
  const startCountdown = () => {
    let [minutes, seconds] = remainingTime.split(":").map((str) => parseInt(str));
            ...
            <div className='mt-28'>
                ...
                <div className='w-[21.875rem] md:w-[45rem] flex justify-center  mb-6'>
                    <div className='w-[21.875rem] md:w-[30rem] flex justify-between items-center'>
                     <p  className='text-base text-primary  font-WorkSans font-normal leading-5  text-left'>{remainingTime}</p> 
                     {remainingTime == '01:00' ?  <button  onClick={() => {
                        sendCode()
                        startCountdown()
                        }} className='text-base text-primary bg-transparent font-WorkSans font-normal leading-5  text-right'>Resend code</button> : <button disabled  onClick={sendCode} className='text-base text-primary bg-transparent font-WorkSans font-normal leading-5  text-right'>Resend code</button>}
                    </div>
                </div>
                <div className='flex justify-center  mb-16 w-[21.875rem] md:w-[45rem]' onClick={() => handleSubmit()}>
                    <ButtonRegular
                    backgroundColor='bg-primary'
                    color='text-white'
                    height='h-11'
