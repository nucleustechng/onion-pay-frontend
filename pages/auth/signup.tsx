		...
		if (isSuccess && signupData?.success == true) {
			...
			switch (signupData?.reason) {
				case "Your Password must be at least eight characters long and consist of letters and numbers":
					setPasswordError(
						"Your Password must be at least eight characters long and consist of letters and numbers"
					);
					break;
				case "Another Merchant is currently using your email address. Please use another.":
					setEmailError(
						"Another Merchant is currently using your email address. Please use another."
					);
					break;
				case "Phone Number format invalid. Your Phone Number must be local to your country":
					setPhoneError(
						"Phone Number format invalid. Your Phone Number must be local to your country"
					);
					break;
				case "Another Merchant is currently using your phone number. Please use another.":
					setPhoneError(
						"Another Merchant is currently using your phone number. Please use another."
					);
					break;
			...
			<div className="flex  justify-center">
				<div className="flex flex-col pt-24 pb-20 mt-8">
					<div className="flex flex-col gap-10">
						<h1
							className="w-[22.875rem] sm:w-[25rem] xl:w-[70rem]  text-center text-[#303778] text-5xl font-SpaceGrotesk font-bold leading-[3.375rem]
                    lg:w-[60rem] lg:text-[5.625rem] lg:leading-[5.625rem]
                    "
						>
							{`Let’s get you`}
							<span className="text-[#FF9635]"> started</span>
