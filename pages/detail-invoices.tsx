    ...
    const ListComponent = ({header,subText,itemNumber}:Props) => (
        <div className='flex items-start gap-7 mx-4 md:mx-[5rem]  xl:mx-[9.375rem] mt-8 md:mt-16 lg:mt-[5.625rem]'>
            <div className='flex justify-center items-center w-8 h-8 md:w-11 md:h-11 bg-[#FF9635] rounded-full'>
                <h1 className='text-white text-lg font-WorkSans font-normal leading-5'>{itemNumber}</h1>
            </div>
            <div className='w-[18rem] md:w-[36rem]  flex flex-col gap-3'>
                <h1 className='text-[#1B1A1A] text-xl md:text-2xl font-WorkSans font-semibold leading-6 md:leading-7'>{header}</h1>
                <p className='text-xl text-[#1B1A1A] font-WorkSans font-normal leading-7'>{subText}</p>
            </div>
    </div>
    )
  return (
        ...
        <div className='h-[30rem] md:h-[50rem] mt-32 mb-[35rem] lg:mb-[60rem]'>
            <div  className='lg:flex lg:justify-between '>
                <div className='flex flex-col gap-6  w-[10rem] mx-4 md:pt-32 md:ml-[5rem] lg:ml-[4rem] xl:ml-[9.375rem]'>
                    ...
                    font-bold leading-[4.5rem] md:leading-[5rem]'>Create professional <span className='text-[#FF9635]'>invoices<span className='italic'>!</span></span></h1>
                    <p className='w-[22rem] md:w-[26.125rem] h-[1.875rem] text-xl  md:text-2xl text-[#1B1A1A] font-WorkSans font-normal  leading-[1.875rem]'>We give you the right template to create professional invoices to share with your customers.</p>
