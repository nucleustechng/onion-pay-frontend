        ...
        <div className="w-[30rem] md:w-[60rem] xl:w-[71.5rem] mt-5 lg:mx-6 lg:mt-7">
          <div className="flex flex-col lg:flex lg:flex-row lg:items-center  lg:justify-between">
            <div className="flex justify-between items-center mx-5 lg:mx-0">
              <h1 className="text-[#262626] text-[2rem] lg:text-[2rem] font-WorkSans font-medium leading-9  lg:mx-0">
                Customers
              </h1>
              {!sidebarShow && (
                <div
            ...
            <div className="flex items-center gap-[1.13rem] mt-5 lg:mt-0 mx-5 lg:mx-5 mb-5 lg:mb-0">
              <div className="w-[18.8rem] h-11 flex items-center  rounded-[0.65rem]">
                ...
                <input
                  type="text"
                  className="w-[18.8rem] h-11 text-sm font-normal font-WorkSans pl-12 leading-4 rounded-[0.65rem] border-solid border-[0.07rem] border-[#CACACA]"
                  placeholder="Search"
                />
              </div>
          ...
          <div className="flex items-center gap-6 mx-5 mb-2 lg:mb-0 lg:mx-0 lg:mt-12">
            <h1
              className={`text-base font-normal leading-5 text-[#262626] font-WorkSans  ${tab === 1 ? "underline underline-offset-[0.6rem]" : ""} cursor-pointer decoration-4 decoration-[#3063E9] pb-2`}
              onClick={() => {
                toggleTab(1);
              }}
            >
            ...
            <h1
              className={`text-base font-normal leading-5   ${tab === 2 ? "underline underline-offset-[0.6rem]" : ""} cursor-pointer decoration-4 decoration-[#3063E9] text-[#262626] font-WorkSans pb-2`}
              onClick={() => {
                toggleTab(2);
              }}
            >
